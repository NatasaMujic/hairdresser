...
try {
    ...
    $mail->Body = "Click the following link to activate your account: <a href='http://localhost:80/hairdresser_project/activate.php?code=" . urlencode($encodedActivationCode) .  "'>Activate</a>";
