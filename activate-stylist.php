...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["code"])) {
    ...
    echo "Your business account has been successfully activated. You can now log in: <a href='http://localhost:80/hairdresser_project/login-as-stylist.php?code'>Log in</a>";
